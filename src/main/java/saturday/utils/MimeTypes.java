    ...
    static {
        mimeTypeMapping = new HashMap<String, String>(200) {
            ...
            }
            {
                ...
                put1(MIME_TEXT_SGML, "sgm");
                put1(MIME_TEXT_CSS, "css");
                put1(MIME_TEXT_CALENDAR, "ifb");
                put1(MIME_TEXT_CALENDAR, "ics");
                put1(MIME_MODEL_VRLM, "wrl");
                ...
                put1(MIME_AUDIO_X_PN_REALAUDIO, "ram");
                ...
                put1(MIME_APPLICATION_XHTML_XML, "xht");
                ...
                put1(MIME_APPLICATION_X_TEXINFO, "texinfo");
                ...
                put1(MIME_APPLICATION_X_NETCDF, "nc");
                put1(MIME_APPLICATION_X_LATEX, "latex");
                put1(MIME_APPLICATION_X_KOAN, "skp");
                ...
                put1(MIME_APPLICATION_X_DIRECTOR, "dcr");
